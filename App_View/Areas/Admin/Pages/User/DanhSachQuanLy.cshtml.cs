...
namespace App_View.Areas.Admin.Pages.User
{
    ...
    public class DanhSachQuanLyModel : PageModel
    {
        private readonly UserManager<NguoiDung> _userManager;
        public DanhSachQuanLyModel(UserManager<NguoiDung> userManager)
        {
        ...
        {
            var usersInRole = await _userManager.GetUsersInRoleAsync(ChucVuMacDinh.Admin.ToString());
