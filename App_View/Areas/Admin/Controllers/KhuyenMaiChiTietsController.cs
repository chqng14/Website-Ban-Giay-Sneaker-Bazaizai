...
namespace App_View.Areas.Admin.Controllers
{
    ...
    public class KhuyenMaiChiTietsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdKhuyenMaiChiTiet,IdKhuyenMai,IdSanPhamChiTiet,MoTa,TrangThai")] KhuyenMaiChiTiet khuyenMaiChiTiet)
        {
            ...
            await httpClient.PostAsync($"https://bazaizaiapi.azurewebsites.net/api/KhuyenMaiChiTiet?mota={khuyenMaiChiTiet.MoTa}&trangThai={khuyenMaiChiTiet.TrangThai}&IDKm={khuyenMaiChiTiet.IdKhuyenMai}&IDSpCt={khuyenMaiChiTiet.IdSanPhamChiTiet}", null);
                    ...
                    foreach (var IdProduct in selectedProducts)
                    {
                        ...
                        if (saledetail != null && saledetail.Count() > 0)
                        {
                            ...
                            else
                            {
                                ...
                                await httpClient.PostAsync($"https://bazaizaiapi.azurewebsites.net/api/KhuyenMaiChiTiet?mota={addSale.MoTa}&trangThai={addSale.TrangThai}&IDKm={addSale.IdKhuyenMai}&IDSpCt={addSale.IdSanPhamChiTiet}", null);
