...
namespace App_View.Areas.Admin.Controllers
{
    ...
    public class KhuyenMaiChiTietsController : Controller
    {
        ...
        public async Task<IActionResult> ApllySale()
        {
            ...
            var getallProductDT = (await sanPhamChiTietService.GetListSanPhamChiTietAsync()).Where(x => x.TrangThaiSale == (int)TrangThaiSaleInProductDetail.DuocApDungSale || x.TrangThaiSale == (int)TrangThaiSaleInProductDetail.DaApDungSale).Select(item => CreateSanPhamDanhSachViewModel(item));
