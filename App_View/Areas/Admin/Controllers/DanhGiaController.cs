...
namespace App_View.Areas.Admin.Controllers
{
    ...
    public class DanhGiaController : Controller
    {
        ...
        //{
        //    var lst = JsonConvert.DeserializeObject<List<DanhGia>>(await (await httpClient.GetAsync("https://bazaizaiapi.azurewebsites.net/api/DanhGia")).Content.ReadAsStringAsync()).ToList();
        ...
        public async Task<IActionResult> TongSoDanhGiaCuaMoiSpChuaDuyet()
        {
            //string apiUrl = "https://bazaizaiapi.azurewebsites.net/api/DanhGia/GetTongSoDanhGiaCuaMoiSpChuaDuyet";
