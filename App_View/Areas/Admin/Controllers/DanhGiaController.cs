...
namespace App_View.Areas.Admin.Controllers
{
    ...
    public class DanhGiaController : Controller
    {
        ...
        //{
        //    var lst = JsonConvert.DeserializeObject<List<DanhGia>>(await (await httpClient.GetAsync("https://bazaizaiview.azurewebsites.net/api/DanhGia")).Content.ReadAsStringAsync()).ToList();
