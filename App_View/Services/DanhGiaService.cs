       ...
       int SaoSp, int SaoVanChuyen, string IdNguoiDung, string IdSanPhamChiTiet, string? MoTa, string? ChatLuongSanPham)
        {
            try
            {
                string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/AddDanhGia?IdDanhGia={IdDanhGia}&BinhLuan={BinhLuan}&ParentId={ParentId}&SaoSp={SaoSp}&SaoVanChuyen={SaoVanChuyen}&IdNguoiDung={IdNguoiDung}&IdSanPhamChiTiet={IdSanPhamChiTiet}&MoTa={MoTa}&ChatLuongSanPham={ChatLuongSanPham}";
                var response = await _httpClient.PostAsync(apiUrl, null);
                if (response.IsSuccessStatusCode)
                {
                    return true;
        ...
        {
            string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/XoaDanhGia/{id}";
            try
            {
        ...
        {
            string apiUrl = "https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/GetAllDanhGia";
        ...
        {
            string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/GetListAsyncViewModel?idspchitiet={Idchitietsp}";
            try
            {
                var apiData = await _httpClient.GetStringAsync(apiUrl);
        ...
        {
            string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/GetDanhGiaById/{id}";
            try
            {
                var response = await _httpClient.GetAsync(apiUrl);
        ...
        public async Task<bool> UpdateDanhGia(DanhGia danhGia)
        {
            try
            {
                string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/ChinhSuaDanhGia?IdDanhGia={danhGia.IdDanhGia}&BinhLuan={danhGia.BinhLuan}&SaoSp={danhGia.SaoSp}&SaoVanChuyen={danhGia.SaoVanChuyen}&IdNguoiDung={danhGia.IdNguoiDung}&IdSanPhamChiTiet={danhGia.IdSanPhamChiTiet}";
        ...
        {
            string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/GetLstChiTietDanhGiaCuaMoiSpChuaDuyet?idSanPham={idSanPham}";
        ...
        public async Task<bool> DuyetDanhGia(string IdDanhGia)
        {
            try
            {
                string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/DuyetDanhGia?IdDanhGia={IdDanhGia}";
        ...
        {
            string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/GetTongSoDanhGia?idspchitiet={idspchitiet}";
        ...
        {
            string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/GetSoSaoTB?idspchitiet={IdProductChiTiet}";
        ...
        {
            string apiUrl = $"https://bazaizaiapi-v2.azurewebsites.net/api/DanhGia/GetDanhGiaViewModelById/{id}";
            try
            {
                var response = await _httpClient.GetAsync(apiUrl);
